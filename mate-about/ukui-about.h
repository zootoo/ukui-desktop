...
#ifndef __UKUI_ABOUT_H__
#define __UKUI_ABOUT_H__
...
const char* program_name = "UKUI Desktop Environment";
const char* version = PACKAGE_VERSION;
const char* icon = "ukui";
const char* website = "http://www.ukui-desktop.org/";

const char* copyright =  ""
    "Copyright © 1997-2011 GNOME developers\n"
    "Copyright © 2011 Perberos\n"
    "Copyright © 2012-2017 UKUI developers";
...
const char* comments_array[] = {
    N_("UKUI provides an intuitive and attractive desktop to Linux users "
    "using traditional metaphors."),

    N_("UKUI includes most of what you see on your computer, including the file "
    "manager, document viewer, image viewer, menus, and many applications."),

    N_("UKUI is a Free, usable, stable, accessible desktop environment for the Unix-"
    "like family of operating systems."),

    N_("UKUI is the continuation of GNOME 2. Hundreds of people have contributed code to "
    ...
    "UKUI is here to provide that same desktop to you!"),

    N_("The name “UKUI” comes from yerba maté, a species of holly native "
    "to subtropical South America. Its leaves contain caffeine and are "
    "used to make infusions and a beverage called ukui.")
};
...
const char* authors[] = {
    ...
    /* UKUI developers and contributors */
    ...
    /* UKUI Google Summer of Code students */
...
// widget for ukui-about window
GtkAboutDialog* ukui_about_dialog = FALSE;

GtkApplication* ukui_about_application;

/**
 * If this value is set to TRUE, then ukui_about_dialog will not be called
 * on the main function.
 */
gboolean ukui_about_nogui = FALSE;
// functions
void ukui_about_run(void);
void ukui_about_release_version(void);

static void ukui_about_on_activate(GtkApplication* app);

// arguments definitions
static GOptionEntry command_entries[] = {
    {"version", 'v', 0, G_OPTION_ARG_NONE, &ukui_about_nogui, "Show UKUI version", NULL},
    {NULL}
};

#endif /* __UKUI_ABOUT_H__ */
