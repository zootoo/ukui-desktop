/*
 * ukui-dconf.c: helper API for dconf
 *
...
static DConfClient *
ukui_dconf_client_get (void)
{
    return dconf_client_new ();
}

/**
 * ukui_dconf_write_sync:
 ...
 */
gboolean
ukui_dconf_write_sync (const gchar  *key,
                       GVariant     *value,
                       GError      **error)
{
    gboolean     ret;
    DConfClient *client = ukui_dconf_client_get ();
 ...
 */
gboolean
ukui_dconf_recursive_reset (const gchar  *dir,
                            GError      **error)
{
    gboolean     ret;
    DConfClient *client = ukui_dconf_client_get ();
 ...
 */
gchar **
ukui_dconf_list_subdirs (const gchar *dir,
